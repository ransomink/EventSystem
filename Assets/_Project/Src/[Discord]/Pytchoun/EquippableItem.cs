...
{
    FrontArmor, RearArmor, RightArmor, LeftArmor, Wheel, Tires, Engine
}
...
public class EquippableItem : Item
{
    ...
    public bool CanRepair
    {
        get
        {
            if ( ArmorDurability > CurrentArmorDurability )
            {
                return true;
            }

            Debug.Log( $"{ItemName} is not damaged. Cannot be repaired" );
            return false;
        }
    }
    ...
    //    CurrentArmorDurability = ArmorDurability;
    //    return true;
    //}
